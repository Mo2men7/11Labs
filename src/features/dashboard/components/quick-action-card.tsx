...
import type { QuickAction } from "../data/quick-adctions";
import { Button } from "@/components/ui/button";
import Link from "next/link";
import { ArrowRight } from "lucide-react";

type QucikActionCard = QuickAction;

export function QucikActionCard({
  title,
  description,
  gradient,
  href,
  ...
  return (
    <div className="flex gap-4 rounded-xl border bg-card p-3">
      <div
        className={cn(
          "relative h-31 w-32 shrink-0 overflow-hidden rounded-xl bg-linear-to-br",
          gradient,
        )}
      >
