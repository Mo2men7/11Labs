...
function NavSection({ label, items, pathname }: NavSelectionProps) {
  return (
    <SidebarGroup>
      {label && (
              ...
              <SidebarMenuButton
                ...
                isActive={
                  item.url
                    ...
                    : false
                  // item.url===pathname but in an advanced way
                }
...
export function DashboardSidebar() {
  ...
  const otherMenuItems: MenuItem[] = [
    ...
    },
    {
      ...
      url: "mailto:momenhelmy@muslim.com",
      icon: Headphones,
    },
  ];
      ...
      <SidebarMenu>
        <SidebarMenuItem>
          <OrganizationSwitcher
            hidePersonal
            fallback={
              <Skeleton className="h-8.5 group-data-[collapsible=icon]:size-8 rounded-md border bg-background" />
            }
            appearance={{
              elements: {
                rootBox:
                  "w-full! group-data-[collapsible=icon]:w-auto! group-data-[collapsible=icon]:flex! group-data-[collapsible=icon]:justify-center! p-2",
                ...
                organizationPreviewTextContainer:
                  "text-xs! tracking-tight! text-foreground! font-medium! group-data-[collapsible=icon]:hidden!",
