  ...
  return (
    <div className="flex h-full flex-col items-center justify-center gap-2 p-8">
      <div className="relative flex w-25 items-center justify-center">
        <div className="abosulte left-0 -rotate-30 rounded-full bg-muted p-3">
        ...
        <div className="abosulte right-0 -rotate-30 rounded-full bg-muted p-3">
      ...
      <p className="max-2-48 text-center textxs text-muted-foreground">
