...
export function VoicePreviewPlaceholder() {
  return (
    <div
      className="hidden flex-1 lg:flex h-full flex-col items-center
  justify-center gap-6 border-t"
    >
      <div className="flex flex-col items-center gap-3">
        <div className="relative flex w-32 items-center justify-center">
          <div className="abosulte left-0 -rotate-30 rounded-full bg-muted p-4">
          ...
          <div className="abosulte right-0 -rotate-30 rounded-full bg-muted p-4">
            <AudioLines className="size-5 text-muted-foreground" />
          </div>
        </div>

        <p className="text-lg font-semibold tracking-tight text-muted-foreground">
          Preview will appear hear
        </p>
      ...
      <Button variant="outline" size="sm" asChild>
        <Link href="mailto:momen.helmy.m@gmail.com">
          <BookOpen />
          Don&apos;t know how?
        </Link>
      </Button>
